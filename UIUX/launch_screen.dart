    ...
    Navigator.of(context).pushReplacement(
      PageRouteBuilder<void>(
        ...
        pageBuilder: (_, __, ___) =>
            hasProjects ? const _HomeRoute() : const FirstRunScreen(),
...
/// Placeholder so this file compiles standalone. Point it at your real home
/// screen — `PortfolioDashboardScreen` once the digest panel is in it.
