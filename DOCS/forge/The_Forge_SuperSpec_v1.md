...
```json
{
  ...
  "platform": "Flutter desktop macOS (all three modes — see Open Flag)",
  "platformNote": "SuperSpec draft said Web (Watch/Reverse) + macOS (Plan). See audit log entry 002 — Flutter-across-all-modes is the recommended default given existing codebase. Resolve before Watch mode build begins.",
  "lockedAt": "2026-06-03",
